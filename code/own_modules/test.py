...
def sayHello():
  return _test.sayHello()
sayHello = _test.sayHello

def fact(*args):
  return _test.fact(*args)
fact = _test.fact

def showPlaatje(*args):
  return _test.showPlaatje(*args)
...
def toOtsu(*args):
  return _test.toOtsu(*args)
toOtsu = _test.toOtsu

def toClose(*args):
  return _test.toClose(*args)
toClose = _test.toClose

def both(*args):
  return _test.both(*args)
both = _test.both
